...
SELECT 
    n + 15000 AS patient_id, -- distinct IDs (shifted to avoid collisions with readmission data)
    CASE
...
SELECT 
    ...
    n + 15000 AS patient_id,          -- Maps 1:1 to new patients (offset to avoid collisions)
...
SELECT 
    n + 15000 AS encounter_diagnosis_id,
    n + 15000 AS encounter_id,
...
SELECT 
    n + 15000 AS encounter_procedure_id,
    n + 15000 AS encounter_id,
